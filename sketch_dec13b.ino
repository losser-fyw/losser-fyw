...
const char ssid[]     = "fu";         // 使用时请修改为当前你的 wifi 名称 -- Please use your own wifi ssid
...
const char APIKEY[] = "HwbUcYVNVNMd1EZzxKTpmgm2=dM=";    // 使用时请修改为你的API KEY -- Please use your own API KEY
int32_t DeviceId = 643323496;                             // 使用时请修改为你的设备ID -- Please use your own device ID
char DataStreams[] = "switch";                // 数据流 LIGHT -- Stream "LIGHT"
